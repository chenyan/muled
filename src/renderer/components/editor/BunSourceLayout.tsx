...
import BunTerminalPane from './BunTerminalPane';
import './SchemeSourceLayout.css';
import './SchemeTerminalPane.css';

interface BunSourceLayoutProps {
...
export default function BunSourceLayout({
  terminalSessionId,
  terminalExitCode = null,
  onCloseTerminal,
  onTerminalExit,
  children,
}: BunSourceLayoutProps) {
